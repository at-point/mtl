  ...
  context '#render' do
    ...
    it 'renders a file card with filename, href and a custom title' do
      expect(subject.render('Document Dolorem.jpg', '/path/to/file.jpg', title: 'foo')).to match_dom <<-HTML
        <a title="foo" target="_blank" class="card-panel " data-mtl-document-modal="open" data-mtl-document-name="Document Dolorem.jpg" href="/path/to/file.jpg">
          <strong>foo</strong>
          Document Dolorem.jpg
          <span class="grey-text">
            <i class="material-icons red-text">image</i>
    ...
    it 'renders a file card with filename, href and a custom preview' do
      expect(subject.render('Document Dolorem.jpg', '/path/to/file.jpg', preview: '/path/to/preview.jpg')).to match_dom <<-HTML
        <a title="Document Dolorem.jpg" target="_blank" class="card-panel card-panel-image" data-mtl-document-modal="open" data-mtl-document-name="Document Dolorem.jpg" style="background-image: url(/path/to/preview.jpg)" href="/path/to/file.jpg">
          Document Dolorem.jpg
          <span class="grey-text">
            <i class="material-icons red-text">image</i>
            JPG
